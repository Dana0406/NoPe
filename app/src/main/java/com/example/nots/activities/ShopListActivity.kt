...
import com.example.nots.databinding.ActivityShopListBinding
import com.example.nots.db.MainViewModel
import com.example.nots.db.ShopListItemAdapter
import com.example.nots.dialogs.EditListItemDialog
...
import com.example.nots.utils.ShareHelper
...
class ShopListActivity : AppCompatActivity(), ShopListItemAdapter.Listener {
    ...
    private fun saveItemCount(){
        ...
        adapter?.currentList?.forEach{
            if(it.itemChecked) checkedItemCounter += 1
        }
